...
**LiveHub** 是一个类“大众点评”的本地生活服务平台，此仓库README主要用于存放学习期间关于此项目的一些思考。
...
2. 对于 LiveHub这个秒杀优惠券的秒杀场景，我关注的是‘业务公平性’与‘严格风控’。 在这个场景下，我主要针对 IP 维度进行限流，目的是防止黄牛刷单和爬虫抓取。它强制要求请求必须在时间轴上均匀分布，这是对抗爬虫和刷单最有效的手段。所以在这种风控场景，要的是死板和精准，滑动窗口是最佳选择。
